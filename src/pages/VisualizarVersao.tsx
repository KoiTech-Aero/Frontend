import { History, InfoIcon, NotepadText } from "lucide-react";
      ...
      <section className="max-w-6xl w-full h-max px-6 my-3 mx-auto flex flex-col gap-5">
        ...
        <section className="flex flex-col gap-5 bg-white rounded-md p-5 shadow-[0px_0px_5px_5px_rgba(0,0,0,0.1)]">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg md:text-xl font-bold">Notas</h3>
          </div>

          <div className="flex flex-col gap-3">
            {versao.notas?.filter((n) => n.status === "Aprovado").length ? (
              versao.notas
              ...
              <p className="text-gray-500 italic">
                Nenhuma nota aprovada cadastrada.
              </p>
            )}
          </div>
        </section>
